...
Vector3 operator/(const Vector3& v, float k) { return Multiply(1.0f/k, v); }

//void operator+=(Vector3& v1, const Vector3& v2) { v1 = Add(v1, v2); }
//void operator-=(Vector3& v1, const Vector3& v2) { v1 = Subtract(v1, v2); }
